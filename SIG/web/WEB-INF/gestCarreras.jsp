<%--
	Document   : gestCarreras
	Created on : May 30, 2013, 1:37:50 AM
	Author	 : brian-m
--%>
...
<body> <br><br><br><br><br><br><br><br><br>
	...
	<h2 style="text-align:center; font-size: 30px"> Gestion de Carreras </h2>
		<center>
		<s:form action="agregarCarrera" namespace="/" method="POST">
			<p class="c2"><input type="submit" name="sub" value="Agregar Carrera" width="75"/></p>
		</s:form>
		<br />
		<s:form action="consultarCarrera" namespace="/" method="POST">
			<p class="c2"><input type="submit" name="sub" value="Consultar Carrera" width="75"/></p>
		</s:form>
		<br />
