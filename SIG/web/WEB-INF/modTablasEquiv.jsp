<%--
	Document   : modTablasEquiv
	Created on : May 30, 2013, 4:50:40 AM
	Author	 : brian-m
--%>
...
<h2 style="text-align:center; font-size: 30px"> Modificar Tabla de Equivalencia </h2>
		<br />
		<br />
		<center>
		<s:form action="consultarTabla" namespace="/" method="POST">
